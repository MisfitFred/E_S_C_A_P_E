...
/*Changed by Fred*/
a3e_arr_Escape_PrisonGuardType = "rhs_msv_officer_armored";
...
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ItemCompass", 50, 8, 15]];
...
/* start Changed by Fred: Add ACE Support*/
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_RangeCard",       20, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_EarPlugs",        80, 5, 10]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_DefusalKit",      30, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_Clacker",         100, 3, 8]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_CableTie",        50, 5, 10]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_Sandbag_empty",   100, 5, 10]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_surgicalKit",     80, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_personalAidKit",  80, 5, 10]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_quikclot",        100, 5, 10]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_salineIV_250",    50, 4, 6]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_salineIV_500",    50, 4, 6]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_salineIV",        50, 4, 6]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_bloodIV_250",     50, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_bloodIV_500",     50, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_bloodIV",         50, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_plasmaIV_250",    50, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_plasmaIV_500",    50, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_plasmaIV",        50, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_epinephrine",     50, 1, 50]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_atropine",        50, 1, 50]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_morphine",        50, 1, 50]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_tourniquet",      50, 1, 5]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_elasticBandage",  100, 10, 20]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_packingBandage",  100, 10, 20]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_fieldDressing",   100, 10, 20]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_MapTools",        10, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_wirecutter",      10, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ACE_Banana",          10, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["ToolKit",             50, 1, 3]];
a3e_arr_AmmoDepotItems set [count a3e_arr_AmmoDepotItems, ["MineDetector",	  50, 1, 3]];




/* Start backpack equipment*/
a3e_startMedicBackpackItems = [];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_EarPlugs",        50, 1, 2]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_surgicalKit",     80, 1, 2]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_personalAidKit",  80, 2, 3]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_quikclot",        100, 5, 10]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_salineIV_250",    50, 1, 2]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_salineIV_500",    50, 1, 2]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_salineIV",        50, 1, 2]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_epinephrine",     100, 10, 15]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_atropine",        100, 1, 5]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_morphine",        100, 10, 15]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_tourniquet",      100, 1, 4]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_elasticBandage",  100, 10, 20]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_packingBandage",  100, 10, 20]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_fieldDressing",   100, 10, 20]];
a3e_startMedicBackpackItems set [count a3e_startMedicBackpackItems, ["ACE_Banana",          100, 1, 1]];

/* end Changed by Fred: Add ACE Support*/
