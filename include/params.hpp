class Params
{
	...
	/* changed by Fred: Not yet finished */
	class Param_MechanInfCompanyForce
	{
		title="mechan inf company force (parameter not used yet)";
		values[]={0,1,2};
		texts[]={"reduced","normal","Battalion"};
		default = 1;
	};
